...
files = get_files(f"/home/disk/hermes/nd349/data/inversion/posterior/BEACON/torch_emulator_no_lstm_posterior_BEACON/{mode}/", extension=".ncdf")
...
def create_submission_bash(date, term, node=''):
    ...
    with open('job.sh', 'w') as file:
        ...
        if emulator:
            file.writelines(f"#SBATCH -o /home/disk/hermes/nd349/data/inversion/runs/logs/torch_emulator_no_lstm_posterior_BEACON/{mode}/{jobname}.out  # send stdout to outfile\n")
        else:
            file.writelines(f"#SBATCH -o /home/disk/hermes/nd349/data/inversion/runs/logs/STILT/{mode}/{jobname}.out  # send stdout to outfile\n")
